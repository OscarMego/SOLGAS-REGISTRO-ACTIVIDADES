<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExcesoTiempo.aspx.cs" Inherits="Reporte_ExcesoTiempo_ExcesoTiempo" %>
        ...
        <div id="wrapper">
            <div class="main">
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.WEB_EXCESO_TIEMPO) %></h2>
                        </div>
                    ...
                    <div class="row">
                        <div id="DivExcesoTiempo" style="width: 90%; height: 500px; float: left"></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            ...
            function reporteGrafico() { //funcion encargada de enviar los parametros a la grilla
                rutaUrl = 'Excesotiempo.aspx/reporteGrafico';
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        reporteGraficoExcesoTiempo('DivExcesoTiempo', data.d.dashEtapasPorEstado);
            ...
            function reporteGraficoExcesoTiempo(div, data) {
                console.log(data);
                Highcharts.theme = {
                    colors: ['#01DF01', '#FE9A2E', '#FE9A2E', '#DDDF00', '#24CBE5', '#64E572',
