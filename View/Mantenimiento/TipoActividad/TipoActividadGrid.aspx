<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoActividadGrid.aspx.cs" Inherits="Mantenimiento_TipoActividad_TipoActividadGrid" %>
        ...
        <div id="divGridView" class="tb-pc" runat="server">
            ...
            <asp:GridView ID="grdMant" GridLines="None" AlternatingRowStyle-CssClass="file"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                        ...
                        <ItemTemplate >
                            ...
                            <div class="btnmovil">
                                ...
                                <a class="changeOption delItemReg" cod="<%# Eval("id") %>"><i class="far fa-trash-alt"></i></a>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="Nombre" HeaderText="Nombres" ItemStyle-HorizontalAlign="Center" />
                    <asp:BoundField DataField="canal" HeaderText="Negocio" ItemStyle-HorizontalAlign="Center" />
