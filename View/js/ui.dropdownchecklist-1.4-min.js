    ...
    */
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendDropContainer: function() {
            ...
            //unique
               $('#centerFrame', window.parent.document).parent().parent().parent().append(wrapper);
		...
		_appendControl: function () {
            ...
            var control = $("<span/>");
            control.addClass("ui-dropdownchecklist cz-form-content-input-select-visible");
            control.css({
                display: "inline-block"
            });
            ...
            textContainer.addClass("ui-dropdownchecklist-text cz-form-content-input-select-visible-text")
            textContainer.css({
                display: "inline-block",
                overflow: "hidden"
            });
            ...
            //controLabel
            var controlLabel = $("<p/>");
            controlLabel.addClass("ui-dropdownchecklist-text");
            controlLabel.addClass("ui-dropdownchecklist-result")
              
            controlLabel.attr("data-placement","bottom");
            controlLabel.attr("data-trigger","hover");
            ...
            //control desplegar
            var inputbutton = $("<div/>");
            inputbutton.addClass("cz-form-content-input-select-visible-button")
            control.append(inputbutton);
        ...
        _createDropItem: function(index, value, text, checked, disabled, indent) {
            ...
            if (self.initialMultiple) { // the checkbox
                checkBox = $('<input type="checkbox" style="float:left" id="' + id + '"' + checkedString + disabledString + '/>');
        ...
        _syncSelected: function(senderCheckbox) {
            ...
            if (options.firstItemChecksAll) {
                ...
                if (senderCheckbox.attr("index") == 0) {
                    ...
                    if(senderCheckbox.attr("checked")=="checked")
                    {
        ...
        //    controlLabel.attr("title", text);
            controlLabel.attr("data-content", text);
