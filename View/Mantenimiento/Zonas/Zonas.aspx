<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Zonas.aspx.cs" Inherits="Mantenimiento_Zonas_Zonas" %>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                Mantenimiento de <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.MAN_WEB_ZONA) %></h2>
                        </div>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'Zonas.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'ZonasNew.aspx'//pantalla de registros
            var urlbus = 'ZonasGrid.aspx'; //grilla
