<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cliente.aspx.cs" Inherits="View.Mantenimiento.Cliente.Cliente" %>
...
<head id="Head1" runat="server">
    ...
    <meta name="description" content="Sistema SOLGAS">
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.MAN_WEB_CLIENTE) %></h2>
                        </div>
                        <div class="col-xs-5 col-md-4">
                            ...
                            <ul class="btn-edit">
                                <li><a href="#"><i class="fas fa-times"></i>
                                    <button type="button" id="btnBorrar" class="btn nuevo delReg" data-toggle="modal" data-target=".bd-example-modal-lg">Borrar</button>
                                </a></li>
                    ...
                    <div class="row filtergrid">
                        <form>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                ...
                                <asp:TextBox ID="txtRuc" runat="server" onkeypress="return fc_PermiteNumeros(event,this);" CssClass="form-control" MaxLength="11"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtRubro">Dirección</label>
                                <asp:TextBox ID="txtDireccion" runat="server" CssClass="form-control" MaxLength="200"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="ddlIdCanal">Negocio</label>
                                <asp:DropDownList ID="ddlIdCanal" runat="server" class="form-control"></asp:DropDownList>
                            </div>
                           <%-- <div class="col-sm-4 col-md-2 form-group">
                                <label for="ddlIdZona">Zona</label>
                                <asp:DropDownList ID="ddlIdZona" runat="server" class="form-control"></asp:DropDownList>
                            </div>--%>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'Cliente.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'ClienteNew.aspx'//pantalla de registros
            var urlbus = 'ClienteGrid.aspx'; //grilla
            ...
            function getParametros() { //funcion encargada de enviar los parametros a la grilla
                ...
                strData.Razon_Social = $('#txtRazonSocial').val();
                strData.RUC = $('#txtRuc').val();
                strData.Direccion = $('#txtDireccion').val();
                strData.Referencia = $('#txtReferencia').val();
                strData.IdCanal = $('#ddlIdCanal').val() == undefined ? 0 : $('#ddlIdCanal').val();
                //strData.IdZona = $('#ddlIdZona').val() == undefined ? 0 : $('#ddlIdZona').val();
