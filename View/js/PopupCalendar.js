...
function getAnchorPosition(anchorname) {
	...
	// Logic to find position
 	if (use_gebi && document.all) {
		...
		x=document.anchors[i].x+document.anchors[i].width;
...
function AnchorPosition_getPageOffsetLeft (el) {
	var ol=el.offsetLeft+el.width+7;
...
function CalendarPopup() {
	...
	c.monthAbbreviations = new Array("Ene","Feb","Mar","Abr","May","Jun","Jul","Ago","Sep","Oct","Nov","Deic");
...
function CP_getCalendar() {
	...
	if (this.type == "WINDOW") {
		...
		result += '<TABLE CLASS="'+this.cssPrefix+'cpBorder" WIDTH=144 BORDER=0 BORDERWIDTH=0 CELLSPACING=0 CELLPADDING=0>\n';
	...
	if (this.displayType=="date" || this.displayType=="week-end") {
		...
		result += '<TR><td><font color="#FFFFFF" style="font-size:3px">a</font></td></TR>\n';
		result += '<TR>\n';
		for (var j=0; j<7; j++) {
		...
		result += '</TR>\n';
		result += '<TR><td><font color="#FFFFFF" style="font-size:2px">a</font></td></TR>\n';
