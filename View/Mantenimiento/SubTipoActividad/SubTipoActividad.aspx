<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubTipoActividad.aspx.cs" Inherits="Mantenimiento_SubTipoActividad_SubTipoActividad" %>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                Mantenimiento Sub Tipo Actividad
                            </h2>
                        </div>
                    ...
                    <div class="row filtergrid">
                        <form>
                            ...
                            <div class="col-sm-4 col-md-2 form-group" >
                                ...
                                <asp:DropDownList ID="ddlTipoActividad" runat="server" class="form-control"></asp:DropDownList>
                            </div>                         
                            <div class="col-sm-4 col-md-2 form-group">
                                <div class="checkbox">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'SubTipoActividad.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'SubTipoActividadNew.aspx'//pantalla de registros
            var urlbus = 'SubTipoActividadGrid.aspx'; //grilla
            ...
            function getParametros() { //funcion encargada de enviar los parametros a la grilla
                ...
                strData.Descripcion = $('#txtDescripcion').val();
                strData.chkFlgHabilitado = $("#chkhabilitado").is(":checked") ? "T" : "F";
                strData.tipoActividad = $("#ddlTipoActividad").val();
                //PAG
