<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OportEtapa.aspx.cs" Inherits="Reporte_OportEtapa_OportEtapa" %>
        ...
        <div id="wrapper">
            <div class="main">
                <div class="container">
                    ...
                    <div class="row">
                        <div id="DivOpPorEtapas" style="width: 90%; height: 500px; float: left"></div>
                    </div>
                </div>
            </div>
        </div>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            ...
            function reporteGrafico() { //funcion encargada de enviar los parametros a la grilla
                rutaUrl = 'OportEtapa.aspx/reporteGrafico';
                $("#loading").show();
                $("#carousel").hide();
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        console.log(data);
                        reporteGraficoOportunidadesPorEtapas('DivOpPorEtapas', data.d.dashOpPorEtapas);
            ...
            function getParametros() { //fcoordinadoruncion encargada de enviar los parametros a la grilla
            ...
            function reporteGraficoOportunidadesPorEtapas(div, data) {
                console.log(data);
                Highcharts.theme = {
                ...
                Highcharts.chart(div, {
                    ...
                    tooltip: {
                        pointFormat: '<tspan style="fill:{point.color}" x="8" dy="15">●</tspan>' + ($('#ddlTipoTotal').val() == '2' ? ' <b>{series.name}: {point.y} TM</b>' : '<span> Oportunidades:</span> <b>{point.y}</b>')
                    },
                    title: {
                        text: data.Titulo
                    },
                    ...
                    series: [{
                        name: ($('#ddlTipoTotal').val() == '2' ? ' TM' : 'Oportunidades'),
                        data: data.items,
                        showInLegend: true
                    }]
                });
