<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="General.aspx.cs" Inherits="Mantenimiento_General_General" %>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                Mantenimiento de <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.MAN_WEB_GENERAL_TIPO) %></h2>
                        </div>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'General.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'GeneralNew.aspx'//pantalla de registros
            var urlbus = 'GeneralGrid.aspx'; //grilla
            ...
            function getParametros() { //funcion encargada de enviar los parametros a la grilla
                ...
                strData.IdTipo = $('#ddlTipo').val() == undefined ? 0 : $('#ddlTipo').val();
