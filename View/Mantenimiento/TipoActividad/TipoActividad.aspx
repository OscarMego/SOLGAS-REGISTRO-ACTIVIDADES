<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoActividad.aspx.cs" Inherits="Mantenimiento_TipoActividad_TipoActividad" %>
...
<body>
                    ...
                    <div class="row filtergrid">
                        <form>
                            ...
                            <div class="col-sm-4 col-md-2 form-group" >
                                ...
                                <asp:DropDownList ID="ddlNegocio" runat="server" class="form-control"></asp:DropDownList>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <div class="checkbox">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'TipoActividad.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'TipoActividadNew.aspx'//pantalla de registros
            var urlbus = 'TipoActividadGrid.aspx'; //grilla
            ...
            function getParametros() { //funcion encargada de enviar los parametros a la grilla
                ...
                strData.idnegocio = $('#ddlNegocio').val();
                //PAG
