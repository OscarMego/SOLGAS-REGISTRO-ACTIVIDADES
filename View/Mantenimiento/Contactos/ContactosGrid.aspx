<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContactosGrid.aspx.cs" Inherits="Mantenimiento_Contactos_ContactosGrid" %>
            ...
            <asp:GridView ID="grdMant" GridLines="None" AlternatingRowStyle-CssClass="file"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                        ...
                        <ItemTemplate >
                            <input id='<%# Eval("IdContacto") %>' value="<%# Eval("IdContacto") %>" type="checkbox">
                            <div class="btnmovil">
                                <button type="button" class="btn nuevo movil editItemReg" title="Editar"
                                    cod="<%# Eval("IdContacto") %>">
                                    <i class="fas fa-pencil-alt"></i>
                                </button>
                                <a class="changeOption delItemReg" cod="<%# Eval("IdContacto") %>"><i class="far fa-trash-alt"></i></a>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="Zona" HeaderText="Zona" ItemStyle-HorizontalAlign="Center" />
