<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contactos.aspx.cs" Inherits="Mantenimiento_Contactos_Contactos" %>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                               ...
                               <%-- <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.MAN_WEB_CONTACTO) %>--%></h2>
                        </div>
                    ...
                    <div class="row filtergrid">
                        <form>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                ...
                                <asp:TextBox ID="txtNombre" runat="server" onkeypress="return SoloAlfanumerico(event);" class="form-control" MaxLength="150"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtTelefono">Telefono</label>
                                <asp:TextBox ID="txtTelefono" runat="server" onkeypress="return SoloAlfanumerico(event);" CssClass="form-control" MaxLength="50"></asp:TextBox>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                ...
                                <asp:TextBox ID="txtCargo" runat="server"  class="form-control" MaxLength="50"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="ddlCliente">Cliente</label>
                                <asp:DropDownList ID="ddlCliente" runat="server" class="form-control"></asp:DropDownList>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'Contactos.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'ContactosNew.aspx'//pantalla de registros
            var urlbus = 'ContactosGrid.aspx'; //grilla
            ...
            function getParametros() { //funcion encargada de enviar los parametros a la grilla
                ...
                strData.Telefono = $('#txtTelefono').val();
