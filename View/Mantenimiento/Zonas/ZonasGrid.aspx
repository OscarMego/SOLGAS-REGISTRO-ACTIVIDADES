<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZonasGrid.aspx.cs" Inherits="Mantenimiento_Zonas_ZonasGrid" %>
                    ...
                    <asp:TemplateField ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                        ...
                        <ItemTemplate>
                            ...
                            <div class="btnmovil">
                                ...
                                <a class="changeOption delItemReg" cod="<%# Eval("IdZona") %>"><i class="far fa-trash-alt"></i></a>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
