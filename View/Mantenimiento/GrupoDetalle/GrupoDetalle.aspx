<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoDetalle.aspx.cs" Inherits="Mantenimiento_GrupoDetalle_GrupoDetalle" %>
...
<body>
                    ...
                    <div class="row filtergrid">
                        <form>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                ...
                                <asp:TextBox ID="txtCodigo" runat="server" onkeypress="return SoloAlfanumerico(event);" MaxLength="15" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtNombre">Nombre</label>
                                <asp:TextBox ID="txtNombre" runat="server" onkeypress="return SoloAlfanumerico(event);" MaxLength="50" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <div class="checkbox">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'GrupoDetalle.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'GrupoDetalleNew.aspx'//pantalla de registros
            var urlbus = 'GrupoDetalleGrid.aspx'; //grilla
