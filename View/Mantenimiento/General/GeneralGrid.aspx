<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GeneralGrid.aspx.cs" Inherits="Mantenimiento_General_GeneralGrid" %>
            ...
            <asp:GridView ID="grdMant" GridLines="None" AlternatingRowStyle-CssClass="file"
                ...
                <Columns>
                    <asp:TemplateField ItemStyle-Width="5%" ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle">
                        ...
                        <ItemTemplate >
                            <input id='<%# Eval("IdGeneral") %>' value="<%# Eval("IdGeneral") %>" type="checkbox">
                            <div class="btnmovil">
                                <button type="button" class="btn nuevo movil editItemReg" title="Editar"
                                    cod="<%# Eval("IdGeneral") %>">
                                    <i class="fas fa-pencil-alt"></i>
                                </button>
                                <a class="changeOption delItemReg" cod="<%# Eval("IdGeneral") %>"><i class="far fa-trash-alt"></i></a>
                            </div>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <%--<asp:BoundField DataField="item" HeaderText="Item" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="40px" />--%>
                    <%--<asp:BoundField DataField="IdTipo" HeaderText="IdTipo" ItemStyle-HorizontalAlign="Center" />--%>
