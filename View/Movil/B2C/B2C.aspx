<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2C.aspx.cs" Inherits="View.Movil.B2C.B2C" %>
...
<body>
    ...
    <script src="../../js/JSModule.js"></script>
     <script type="text/javascript">
         var urlPrin = 'B2C.aspx';
         var urlFillCliente = '../../Movil/B2C/FillCliente.ashx'
    </script>
