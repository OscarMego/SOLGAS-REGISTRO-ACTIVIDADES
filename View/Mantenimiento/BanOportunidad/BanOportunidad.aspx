<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BanOportunidad.aspx.cs" Inherits="BanOportunidad" %>
...
<body>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.MAN_WEB_BAND_OPORTUNIDAD) %></h2>
                        </div>
                    ...
                    <div class="row filtergrid">
                        <form>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtFechaEstimadaInicio">Fecha Estimada Inicio</label>
                                <div class="input-group" data-toggle="datepicker">
                                    <asp:TextBox ID="txtFechaEstimadaInicio" CssClass="form-control" MaxLength="10" type="text" data-date-format="dd/mm/yyyy" name="fechaEstimadaDesde"
                                        onkeypress="javascript:fc_Slash(this.id, '/');" onblur="javascript:fc_ValidaFechaOnblur(this.id);"
                                        runat="server" ReadOnly></asp:TextBox>
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtFechaEstimadaFin">Fecha Estimada Fin</label>
                                <div class="input-group" data-toggle="datepicker">
                                    <asp:TextBox ID="txtFechaEstimadaFin" CssClass="form-control" MaxLength="10" type="text" data-date-format="dd/mm/yyyy" name="fechaEstimadaHasta"
                                        onkeypress="javascript:fc_Slash(this.id, '/');" onblur="javascript:fc_ValidaFechaOnblur(this.id);"
                                        runat="server" ReadOnly></asp:TextBox>
                                    <span class="input-group-btn">
                                        <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                            ...
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="ddlEtapa">Etapa</label>
                                <asp:DropDownList ID="ddlEtapa" runat="server" class="form-control"></asp:DropDownList>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'BanOportunidad.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'BanOportunidadNew.aspx'//pantalla de registros
            var urlbus = 'BanOportunidadGrid.aspx'; //grilla
            var urllog = 'BanOportunidadLog.aspx'; //grilla
            ...
            $(document).ready(function () {
                ...
                logOportunidad();//funcion encargada de mostrar el log de cambios de oportunidad
                ...
                detReg(".cametapa", "BanOportunidadEtapa.aspx");
                detReg(".historial", "BanOportunidadHistorial.aspx");

                $('body').on('click', '.cerrarItemReg', function (e) {

                    var strReg = $(this).attr('cod')
                    $('#myModal').html(alertHtml('delConfirm', "", "¿Esta seguro que desea <b>Cerrar</b> la oportunidad?"));
                    $('#myModal').modal('show');
