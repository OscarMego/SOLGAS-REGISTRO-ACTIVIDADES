<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="Mantenimiento_Usuarios_Usuarios" %>
...
<body>
                    ...
                    <div class="row">
                        <div class="col-xs-7 col-md-8 titulo">
                            <h2><i class="far fa-clipboard"></i>
                                <%=Model.bean.IdiomaCultura.getMensajeEncodeHTML(Model.bean.IdiomaCultura.MAN_WEB_USUARIO) %></h2>
                        </div>
                    ...
                    <div class="row filtergrid">
                        <form>
                            <div class="col-sm-4 col-md-2 form-group">
                                ...
                                <asp:TextBox ID="txtCodigo" runat="server" onkeypress = "return SoloAlfanumerico(event);" CssClass="form-control" MaxLength="10"></asp:TextBox>

                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtNombre">Nombre</label>
                                <asp:TextBox ID="txtNombre" runat="server" onkeypress="return SoloAlfanumerico(event);" class="form-control" MaxLength="80"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <label for="txtLogin">Login</label>
                                <asp:TextBox ID="txtLogin" runat="server"  onkeypress="return SoloAlfanumerico(event);" class="form-control" MaxLength="10"></asp:TextBox>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group" >
                                <label for="ddlPerfil">Perfil</label>
                                <asp:DropDownList ID="ddlPerfil" runat="server" class="form-control"></asp:DropDownList>
                            </div>
                            <div class="col-sm-4 col-md-2 form-group">
                                <div class="checkbox">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>--%>
        ...
        <script type="text/javascript">
            var urlPrin = 'Usuarios.aspx';
            var urldel = urlPrin + '/Desactivate'; //WebMethod para eliminacion
            var urlins = 'UsuariosNew.aspx'//pantalla de registros
            var urlbus = 'UsuariosGrid.aspx'; //grilla
            ...
            $(document).ready(function () {
                //cargaComboMulti(urlPrin + '/ComboMultPerfil', "#ddlPerfil");
            ...
            function getParametros() { //funcion encargada de enviar los parametros a la grilla
                ...
                strData.Login = $('#txtLogin').val();
                strData.Nombres = $('#txtNombre').val();
                strData.chkFlgHabilitado = $("#chkhabilitado").is(":checked") ? "T" : "F";
                strData.Perfiles = $('#ddlPerfil').val();
                //PAG
